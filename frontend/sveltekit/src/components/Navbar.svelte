...
<nav>
	...
	<div id="connection-status">
		Connection: <code id="status">{connectionStatus}</code>
	</div>
	<ul class:active={isMenuActive}>
		...
		<li>
			<a href="/robot" class={activePage === '/robot' ? 'active' : ''} on:click={handleNavLinkClick}
				>Robot</a
			>
		</li>
		<li>
			<a href="/about" class={activePage === '/about' ? 'active' : ''} on:click={handleNavLinkClick}
				>About</a
			>
		</li>
		<li>
			<a
				...
				on:click={handleNavLinkClick}>Specifications</a
			>
		</li>
		<li>
			<a
				...
				on:click={handleNavLinkClick}>Contact</a
			>
		</li>
	</ul>
